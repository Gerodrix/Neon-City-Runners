...
| D-21 | Buy Bonus cuesta 29.5x la apuesta total, calibrado por simulación para que el RTP de la compra sea igual al RTP general del juego (95.99%) | Precio fijo arbitrario / precio más bajo para incentivar la compra | Se corrieron 3 simulaciones grandes (10M-15M giros) para medir cuánto gana en promedio una ronda de Free Spins, y de ahí se derivó el precio — mismo criterio que el resto de la matemática del juego, no se puso un número a ojo | NCR-E11 |

*D-04 a D-07, D-09 a D-21 implementadas (D-15 es una decisión de "no hacer", documentada igual; D-19 reemplaza a D-02 y resuelve D-08).*
